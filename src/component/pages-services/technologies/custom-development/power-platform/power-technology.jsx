...
const PowerPlatformTechnologies = () => {
  const techData = {
    ...
    "Integration": ["Azure Logic Apps", "Microsoft Graph API", "Power Platform APIs", "Azure Functions", "Azure API "]
  };
  ...
  const techLogos = {
    ...
    "Azure API ": "https://www.svgrepo.com/show/358655/azure-api-management.svg"
  };
