...
function WooCommerce() {
  const metaPropsData = {
    title: "WooCommerce Development Services in Chennai | Cybomb Technologies",
    description:
      "Cybomb Tech delivers WooCommerce development services creating secure, scalable, conversion-focused online stores with custom themes, plugins & optimization.",
    keyword:
      "woocommerce development, ecommerce solutions, online store development, wordpress ecommerce, custom ecommerce",
