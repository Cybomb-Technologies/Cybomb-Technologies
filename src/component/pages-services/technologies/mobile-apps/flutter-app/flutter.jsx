...
function FlutterApp() {
  const metaPropsData = {
    title: "Best Flutter Development Services Company in Chennai - Cybomb Tech",
    description:
      "Build stunning high performance Flutter apps in Chennai using a single codebase for Android and iOS ensuring faster deployment and seamless user experience.",
    keyword:
      "flutter app development in chennai, cross-platform apps, mobile app development, flutter developers, hybrid apps, cybomb technologies",
