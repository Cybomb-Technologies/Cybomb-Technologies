...
const services = [
  ...
  },
  {
    ...
    description: "RESTful, GraphQL, cloud, and enterprise systems integration.",
  },
  {
...
const hiringData = [
  {
    title: "Project-Based:",
    description: "Fixed-scope deliverables with set timeline and budget.",
  },
  {
    title: "Dedicated Team / Outstaffing:",
    description: "Scale your team with experienced React developers.",
  },
  {
    title: "Time & Materials / Hourly:",
    description: "Flexible billing tailored to ongoing development needs.",
  },
];
...
const whychooseus = [
  ...
  },
  {
    ...
    description:
      "Powerful integrations (Next.js, GraphQL, Material‑UI, Gatsby, Redux).",
  },
  {
