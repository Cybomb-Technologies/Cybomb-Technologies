...
const offerings = [
  {
    ...
    description:
      "We assess your current process and recommend the right CRM tools and strategy for your business.",
  },
  {
    title: "Custom CRM Development",
    description:
      "Get a fully tailored CRM system built around your business logic, teams, and goals.",
  },
  {
    title: "CRM Platform Implementation",
    description:
      "Expert setup of industry-leading platforms like Salesforce, HubSpot, Zoho, Freshsales, and Microsoft Dynamics.",
  },
  {
    title: "Third-Party Integrations",
    description:
      "Connect your CRM with tools like email marketing platforms, billing systems, ERP, helpdesk, and more.",
  },
  {
    title: "Data Migration & Cleanup",
    description:
      "We securely move and sanitize your customer data during platform migrations.",
  },
  {
...
const whychooseus = [
  {
    ...
    description:
      "We focus on CRM as a revenue enabler not just a contact database.",
  },
  {
    title: "Seamless Integrations",
    description:
      "We ensure your CRM talks to your marketing, sales, and support systems in real time.",
  },
  {
    title: "Industry Expertise",
    description:
      "We have built CRM systems for industries like real estate, healthcare, SaaS, finance, and more.",
  },
  {
    title: "Security & Compliance",
    description:
      "Your customer data is protected with best practices and regulatory compliance (GDPR, HIPAA, etc.).",
  },
  {
    title: "Scalable Solutions",
    description:
      "Start small and grow fast. Our CRM systems scale with your business.",
  },
];
    ...
    <section>
      ...
      <InfoStats
        stats={[
          {
            number: "65%",
            label: "Of businesses adopt CRM within 5 years of launch",
          },
          {
            number: "3×",
            label: "Higher customer retention with proper CRM adoption",
          },
