...
export default function BespokeDev() {
  const metaPropsData = {
    title: "Bespoke Development Services in Chennai | Cybomb Technologies",
    description:
      "Cybomb Tech offers bespoke development services tailored to your key needs, creating custom web, mobile, enterprise apps for scalability and competitive edge.",
    keyword:
      "bespoke development services in chennai, custom software development, tailored web applications, bespoke mobile app development, enterprise software solutions, custom application design",
    url: "https://cybomb.com/services/bespoke-development",
