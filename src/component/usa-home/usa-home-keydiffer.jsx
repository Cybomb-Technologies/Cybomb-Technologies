import "./usa-home-keydiffer.css";

function HomeKeydiffer() {
  return (
    <section
      className="black text-center HomeKeydiffer"
      style={{ padding: "60px 0px" }}
    >
      <div className="container">
        <h2 className="fw-bold mb-2 text-white">Our Key Differentiators</h2>
        <p className="text-black mb-5 text-white">
        ...
        <div className="row g-4">
          <div className="col-md-6 col-lg-3">
            <div className="card h-100 p-4 rounded-4 border-0 differentiator-card">
              ...
              >
                We follow agile practices ensuring faster delivery, continuous
                feedback, and adaptive planning throughout the development
                process.
              </p>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="card h-100 p-4 rounded-4 border-0 differentiator-card">
              ...
              >
                Each project gets a dedicated manager ensuring seamless
                communication, timeline adherence, and quality deliverables.
              </p>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="card h-100 p-4 rounded-4 border-0 differentiator-card">
              ...
              >
                We choose the best technology stack for your specific needs
        ...
        <div className="row g-4 mt-5" style={{ backgroundColor: "#FFFFFF" }}>
