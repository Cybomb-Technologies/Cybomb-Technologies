    ...
    <section style={{ padding: "60px 20px", backgroundColor: "#FFFFFF" }}>
      <div className="container" id="home-contact" style={{ padding: "0px" }}>
        ...
        <div className="contact-flex-container">
              ...
              <div className="d-flex mt-3 align-items-start">
                ...
                {/* <div className="ms-3">
                  ...
                  <p className="mb-0 fs-6 contact-text-color">
                    Cybomb Technologies Pvt Ltd <br /> Prime Plaza No.54/1, 1st
                    street, Sripuram colony,
                    <br />
          ...
          {/* Right Card (Map) */}
          <div className="contact-card-wrapper" style={{ color: "#003459" }}>
            <div
              className="card border-0 shadow map-card"
              style={{ borderRadius: "8px", overflow: "hidden" }} // 👈 Important
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2808.262715304578!2d-106.9648883236847!3d44.79722107107136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5335f8d8b6b8e5c1%3A0x5b5a5e5e5e5e5e5e!2s30%20N%20Gould%20St%20Ste%20R%2C%20Sheridan%2C%20WY%2082801%2C%20USA!5e0!3m2!1sen!2sin!4v1690000000000!5m2!1sen!2sin"
                width="100%"
                height="400"
                allowFullScreen=""
                loading="lazy"
              ...
              <div className="p-5" style={{ backgroundColor: "#003459" }}>
                ...
                <p className="text-white">
                  Located in Sheridan, Wyoming, our US office serves as the hub
                  for our North American operations, providing strategic support
                  and collaboration for our clients across the region.
                </p>
              </div>
            </div>
          </div>
