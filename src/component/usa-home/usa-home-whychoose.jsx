import "./usa-home-whychoose.css";
import { Link } from "react-router-dom";
function Homewhychoose() {
  return (
    <section
      className="why-choose-bg text-white text-center"
      ...
      <div className="container">
        ...
        <div className="row g-4">
          ...
          <div className="col-6 col-md-3">
            <div className="card stat-card p-4 h-100 text-center border-0 rounded-4 border-orange">
              <div
                className="icon-box mx-auto mb-2"
                style={{ backgroundColor: "#007ea7" }}
              >
                <i className="bi bi-people-fill"></i>
              </div>
              <h4 className="fw-bold mb-0" style={{ color: "#007ea7" }}>
                80+
              </h4>
        ...
        <div className="cta-box mt-5 p-4 rounded-4 text-white">
          ...
          <h2 className="text-light small mt-4">
            Transform your business with our proven expertise and dedicated
            support
          </h2>
          <div className="d-flex flex-column flex-md-row justify-content-center gap-3 mt-4">
            <a
              href="#start-project"
              className="btn btn-light px-4 fw-semibold text-primary p-2"
            >
              Start Your Project
            </a>
            <Link
              to="/portfolio"
              className="btn btn-outline-light px-4 fw-semibold p-2"
            >
              View Our Work
            </Link>
          </div>
