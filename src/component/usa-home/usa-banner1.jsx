            ...
            <div className="banner-content-wrapper">
              <h1 className="display-3 display-lg-2 fw-bold mb-4">
                ...
                <span className="dynamic-text-container">
                  <strong className="dynamic-text">
                    {rotatingPhrases[currentPhraseIndex]}
                  </strong>
                </span>
              </h1>
              <p className="lead fs-5 banner-paragraph-content px-3 px-md-5">
                We empower businesses with scalable mobile apps, intelligent AI
                systems, and seamless SaaS platforms — custom-built to fuel your
                growth.
              </p>
