    ...
    <>
      <section className="cookie-policy-content">
        <div className="container p-5" >
          ...
          <div className="mt-4">
            <p>
              This Cookie Policy explains how Cybomb Technologies uses cookies and similar technologies to recognize you when you visit our website at www.cybomb.com. It explains what these technologies are, why we use them, and your rights to control their use.
            </p>
            <p>
