  ...
  <header className={styles.header}>
    <div className={styles.container} style={{ 
      ...
      <div className={styles.logo}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}>
...
const WhiteLabelApp = () => {
  ...
  const [modalMessage, setModalMessage] = useState({ show: false, text: '', type: '' });
  ...
  const showCustomModal = (text, type = 'success') => {
    ...
    setTimeout(() => setModalMessage({ show: false, text: '', type: '' }), 4000);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.email) {
      showCustomModal('Please fill in required fields (Name and Email).', 'error');
    ...
    try {
      ...
      if (response.ok && result.success) {
        showCustomModal('Thank you for your inquiry! Our team will contact you within 24 hours.', 'success');
        // Reset form
        setFormData({
          name: '',
          company: '',
  ...
  const features = [
    {
      ...
      description: 'Your logo, app name, color scheme, and branding elements integrated throughout the entire application experience'
    },
    {
      icon: <GlobeIcon />, // Domain & Hosting
      title: 'Dedicated Domain & Hosting',
      description: 'Launch with your custom domain with SSL certification and enterprise-grade hosting infrastructure'
    },
    {
      icon: <BarChartIcon />, // Admin Dashboard
      title: 'Comprehensive Admin Dashboard',
      description: 'Full administrative control with real-time analytics, user management, and content customization capabilities'
    },
    {
      icon: <ZapIcon />, // Rapid Deployment
      title: 'Rapid Deployment',
      description: 'Go from concept to live production in just 72 hours with our optimized deployment pipeline'
    },
    {
      icon: <SmartphoneIcon />, // Native Mobile Apps
      title: 'Native Mobile Applications',
      description: 'Dedicated iOS and Android apps published under your brand on Apple App Store and Google Play Store'
    },
    {
      icon: <ShieldIcon />, // Security
      title: 'White Label Security',
      description: 'Complete white label solution with no third-party branding, enterprise-grade security, and data protection'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'The white label solution allowed us to launch our branded app in just 3 days. The process was seamless and the support team was exceptional.',
      rating: 5
    },
    {
      name: 'Michael Chen',
      company: 'Innovate Solutions',
      content: 'We needed a custom app solution quickly, and this white label platform delivered beyond our expectations. Highly recommended for startups.',
      rating: 5
    },
    {
      name: 'Emily Rodriguez',
      company: 'Digital Ventures',
      content: 'The ability to completely brand the app as our own while having full admin control has been a game-changer for our business.',
      rating: 5
    }
  ];
        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroDescription}>
              Launch your fully branded mobile application in just 72 hours. Our complete white label 
              solution includes custom branding, native iOS & Android apps, and full administrative 
              control—no technical expertise required.
            </p>
      ...
      <section id="features" className={styles.featuresSection}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p>Everything you need to launch and manage your branded mobile application</p>
          </div>
      ...
      <section id="pricing" className={styles.pricingSection}>
        <div className={styles.container}>
          ...
          <div className={styles.pricingFooter}>
            <p>All plans include our 3-day setup guarantee. Need a custom enterprise solution? <a href="#contact" onClick={(e) => { e.preventDefault(); scrollToSection('contact'); }}>Contact our sales team</a></p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.faqSection}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p>Get answers to common questions about our white label solution</p>
          </div>
          <div className={styles.faqGrid}>
            <div className={styles.faqItem}>
              <h3>How long does the setup process take?</h3>
              <p>Most clients are live within 72 hours after providing their branding assets and requirements. The process includes app configuration, branding implementation, and initial testing.</p>
            </div>
            <div className={styles.faqItem}>
              <h3>Do I need technical expertise to manage the app?</h3>
              <p>No technical expertise is required. Our intuitive admin dashboard allows you to manage content, users, and settings without any coding knowledge.</p>
            </div>
            <div className={styles.faqItem}>
              <h3>Can I customize features after launch?</h3>
              <p>Yes, we offer various customization options. The Professional and Enterprise plans include custom feature development to meet your evolving needs.</p>
            </div>
            <div className={styles.faqItem}>
              <h3>What support is included?</h3>
              <p>All plans include technical support. Starter includes 30 days, Professional includes 90 days, and Enterprise includes ongoing white-label support with SLA guarantees.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className={styles.contactSection}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p>Ready to launch your branded mobile app? Complete the form below and our team will contact you within 24 hours.</p>
          </div>
              ...
              <div className={styles.formGroup}>
                ...
                ></textarea>
                    ...
                    <div className="form-check">
                      ...
                      />
                      <label className="form-check-label text-muted" htmlFor="newsletterSubscribe">
                        Subscribe to our newsletter for project updates and tech insights
                      </label>
                    </div>
              <button 
                type="submit" 
                ...
                disabled={isSubmitting}
              >
                {isSubmitting ? 'Submitting...' : 'Get Started with White Label'}
              </button>
