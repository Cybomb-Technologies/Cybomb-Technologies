  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const contactData = {
        ...
        message: `Source: ${formData.source || 'Not specified'}\n\nProject Details: ${formData.message}`,
      ...
      setSubmitStatus({ 
        success: true, 
        message: 'Thank you! Your project details have been submitted successfully. We\'ll get back to you soon.' 
      });
            ...
            <div className="card p-5 rounded-4 shadow-sm text-white border-0 form mt-1">
              ...
              {!submitStatus?.success ? (
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    <label className="form-label text-white fw-bold">Phone Number</label>
                    <input
                      type="tel"
                      name="phone"
                      className="form-control forminput"
                      ...
                      onChange={handleChange}
                    />
                    <small className="text-white">We'll use this for better communication</small>
                  </div>

                  <div className="mb-3">
                    <label className="form-label text-white fw-bold">How did you find us?</label>
                    <select
                  ...
                  <div className="mb-3">
                    <label className="form-label text-white fw-bold">Project Details *</label>
                    <textarea
                      name="message"
                      className="form-control forminput"
                      rows="4"
                      ...
                      required
                    ></textarea>
                    <small className="text-muted float-end">{formData.message.length}/500 characters</small>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="form-check">
                      ...
                      />
                      <label className="form-check-label text-white" htmlFor="newsletterSubscribe">
                ...
                <div className="text-center py-4">
                  ...
                  <h4 className="text-success mb-3">Project Submitted Successfully!</h4>
                  <p className="text-white mb-4">
                    Thank you for sharing your project details. Our expert will contact you within 24 hours to discuss your requirements.
                  </p>
                  <button 
