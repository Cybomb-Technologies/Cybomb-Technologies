    ...
    <li className="nav-item dropdown custom-nav-item position-static">
      ...
      <ul
        ...
        style={{
          ...
          width: !isMobile && window.innerWidth >= 1400 ? "1100px" : "100%",
        
  left: !isMobile && window.innerWidth >= 1400 ? "700px" : undefined,
        }}
      >
        <li className="w-100">
          <div className="row p-3 bg-white shadow rounded-3 m-0">
            ...
            {/* Column 4 */}
            <div className="col-xxl-3 col-xl-12 col-12 mb-3">
              <span className="dropdown-item text-primary fw-bold">Digital Marketing</span>
