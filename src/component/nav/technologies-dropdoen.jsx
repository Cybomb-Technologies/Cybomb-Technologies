        ...
        <li className="w-100">
          <div className="row p-3 bg-white shadow rounded-3 m-0">
            ...
            <div className="col-xxl-2 col-xl-12 col-md-6 col-12 mb-3">
              ...
              <Link to="/services/react-native" className="dropdown-item" onClick={onLinkClick}>React Native</Link>
              <Link to="/services/ios-app" className="dropdown-item" onClick={onLinkClick}>Ios</Link>
