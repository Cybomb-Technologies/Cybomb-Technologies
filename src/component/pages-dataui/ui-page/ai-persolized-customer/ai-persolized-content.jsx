...
const aiCustomerExperienceDescription = [
  {
    name: "Tealium",
    description:
      "Tealium is a leading Customer Data Platform (CDP) that enables organizations to collect, unify, and activate customer data across all touchpoints in real-time.",
    icon: "https://www.svgrepo.com/show/354439/tealium.svg",
    iconColors: "linear-gradient(135deg, #EAF1FB, #FFFFFF)", // very light blue gradient
  },
  {
    name: "Salesforce CDP",
    description:
      "Salesforce CDP unifies customer data from multiple sources, providing a 360-degree view of customers to enable personalized marketing and engagement.",
    icon: "https://cdn.iconscout.com/icon/free/png-256/free-salesforce-logo-icon-svg-png-download-2945132.png",
    iconColors: "linear-gradient(135deg, #EAF6FF, #ebd1d1ff)", // light sky blue gradient
  },
  {
    name: "Intercom",
    description:
      "Intercom is a conversational relationship platform offering AI-powered chatbots, messaging, and automation to enhance customer engagement and support.",
    icon: "https://img.icons8.com/color/512/intercom.png",
    iconColors: "linear-gradient(135deg, #E9F4FF, #FFFFFF)", // soft blue gradient
  },
  {
    name: "LivePerson",
    description:
      "LivePerson provides AI-powered messaging and conversational commerce solutions, helping brands connect with customers across digital channels.",
    icon: "https://a.mktgcdn.com/p/GKmhkX8wZsYBxXO6dTyJ20PoVilsFv0l2KpjDUY9ufo/1024x1024.png",
    iconColors: "linear-gradient(135deg, #FFF3EB, #FFFFFF)", // light peach-orange gradient
  },
  {
    name: "Tidio",
    description:
      "Tidio is a live chat and AI chatbot platform that helps businesses automate customer support, improve engagement, and increase conversions.",
    icon: "https://cdn.prod.website-files.com/625817c1528a479afc134612/64a429a8a6c85adf05e6927a_Tidio.png",
    iconColors: "linear-gradient(135deg, #EAF3FF, #FFFFFF)", // pale blue gradient
  },
  {
    name: "Mixpanel",
    description:
      "Mixpanel is a product analytics platform that helps teams understand user behavior, track customer journeys, and make data-driven decisions.",
    icon: "https://cdn.appsflyer.com/marketplace/static/logo/mixpanel.png",
    iconColors: "linear-gradient(135deg, #F2EDFF, #FFFFFF)", // soft lavender gradient
  },
];
    ...
    <section>
      ...
      <InfoStats
        stats={[
          {
            number: "80%",
            label: "Of customers buy more with personalization",
          },
          {
            number: "5×",
            label: "Boost in engagement with AI recommendations",
          },
          {
            number: "60%",
            label: "Reduction in churn with retention strategies",
          },
        ]}
      ...
      <AboutTech technologies={aiCustomerExperienceDescription} />
