...
export default function CloudSecurity() {
  const metaPropsData = {
    title: "Cloud Security Services in Chennai | Cybomb Technologies",
    description:
      "Cybomb Technologies delivers Cloud Security Services protecting data, applications, infrastructure across AWS, Azure, Google Cloud with encryption & monitoring.",
    keyword:
      "cloud security services in chennai, cloud threat protection, cloud compliance solutions, multi-cloud security, cloud data encryption, cloud security consulting",
  ...
  return (
    <>
      ...
      <AgileProcess1
        ...
        cardView={true}
      />
      <StillNotSure title="Protect your cloud infrastructure with advanced security measures—prevent breaches, ensure compliance, and keep your business running securely." />
