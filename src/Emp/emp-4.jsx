...
import AiAgentCaseStudy from "../component/page-case-study/ai-agent-case-study/ai-agent-case-study";
...
const emp4Routes = (
  <>
    ...
    <Route path="/case-study/ai-agent-case-study" element={<AiAgentCaseStudy/>}/>
