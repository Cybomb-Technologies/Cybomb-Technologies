...
app.use(cors({
  origin: [ 
    ...
    'https://djittrading.com', // ✅ ADD YOUR NEW DOMAIN
    'https://www.djittrading.com' // ✅ ADD YOUR NEW DOMAIN
  ], 
...
app.listen(PORT, () => {
  ...
  console.log(`🌐 Web Payment API: http://localhost:${PORT}/api/web-payment`);
});